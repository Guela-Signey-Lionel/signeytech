  ...
  const teamMembers = [
    {
      ...
      description: 'Fondateur et visionnaire de l\'entreprise, Jean-Baptiste dirige notre équipe avec passion et expertise depuis 2008.',
