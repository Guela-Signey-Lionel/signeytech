    ...
    <section id="produits" className="py-24 bg-white" data-product-shop>
      <div className="container mx-auto px-4">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Add to cart button */}
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap">
        ...
        <div className="text-center mt-12">
          <button className="bg-gray-900 hover:bg-gray-800 text-white font-bold px-8 py-4 rounded-xl transition-colors inline-flex items-center gap-2 cursor-pointer whitespace-nowrap">
