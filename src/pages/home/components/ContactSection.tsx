...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://readdy.ai/api/form/d4as9rsrg8gnguu954mg', {
        method: 'POST',
        headers: {
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-blue-100">Avenue de l'Indépendance, Gobongo, Bangui, République Centrafricaine</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-blue-100">+236 75 31 30 98</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-blue-100">contact@signeytech.com</div>
                    <div className="text-blue-100">support@signeytech.com</div>
                  </div>
                </div>
