      ...
      <div className="container mx-auto px-4 text-center text-white">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-white/90">+236 75 31 30 98</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-white/90">contact@signeytech.com</p>
            <p className="text-white/90">services@signeytech.com</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-white/90">Avenue de l'Indépendance, Gobongo</p>
